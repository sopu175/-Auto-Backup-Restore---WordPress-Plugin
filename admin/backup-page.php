...
<div class="wrap">
    ...
    <div class="abr-actions">
        <form method="post" style="display: inline-block;">
            ...
            <input type="submit" name="abr_create_backup" class="button button-primary button-large" value="<?php _e('Create Backup Now', ABR_TEXT_DOMAIN); ?>">
        </form>
        
        <a href="<?php echo admin_url('admin.php?page=abr-settings'); ?>" class="button button-secondary"><?php _e('Settings', ABR_TEXT_DOMAIN); ?></a>
    </div>
