...
class AutoBackupRestore {
    ...
    private function init_hooks() {
        ...
        // AJAX hooks
        add_action('wp_ajax_abr_create_backup_now', function() {
            if (!current_user_can('manage_options') || !check_ajax_referer('abr_backup_action', 'abr_nonce', false)) {
                wp_send_json_error(__('Unauthorized.', ABR_TEXT_DOMAIN));
            }
            ...
            if ($backup_result['success']) {
                ...
                wp_send_json_error(is_string($backup_result['message']) ? $backup_result['message'] : __('Backup failed.', ABR_TEXT_DOMAIN));
            }
        });
    }
